...
(function() {
  (function() {
    for (var a = 0, c = ["ms", "moz", "webkit", "o"], b = 0; b < c.length && !window.requestAnimationFrame; ++b) window.requestAnimationFrame = window[c[b] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[c[b] + "CancelAnimationFrame"] || window[c[b] + "CancelRequestAnimationFrame"];
  ...
  window.Typewriter = function(a, c) {
    ...
    !0 === this.options.autoStart &&
      this.options.strings && this.typeOutAllStrings()
  };
  ...
  b.typeOutAllStrings = function() {
    ...
    if (1 === a.length) this._typeCharacters(a[0]);
      ...
      for (var c = 0, b = a.length; c < b; c++) this._addToEventQue([this._typeCharacters, [a[c]]]), this.pauseFor(this._randomInteger(1500, 2500)), this.deleteAll(), this.pauseFor(this._randomInteger(1500, 2500));
    return this
  };
  ...
  b._rerunCalledEvents = function() {
    0 < this._settings.currentTypedCharacters.length ? (this.deleteAll(), this._resetEventLoop("rerunCalledEvents")) : (this._settings.eventQue = this._settings.calledEvents, this._settings.calledEvents = [], this.options = this._setupOptions(this._settings.userOptions),
      this._settings.usedIDs = [], this.charAmountToDelete = !1, this._startEventLoop())
  };
  ...
  b._setupOptions = function(a) {
    ...
    if (this._settings.userOptions)
      for (b in this._settings.userOptions) c[b] = this._settings.userOptions[b];
    for (b in a) c[b] = a[b];
    return c
  };
  ...
  b._startEventLoop = function() {
    ...
    if (!this._settings.eventRunning) {
      if (0 < this._settings.eventQue.length) {
        ...
        "function" == typeof a ? (this._settings.eventRunning = !0, this._settings.calledEvents.push(a),
  ...
  b._typingAnimationFrame = function(a) {
    ...
    setTimeout(function() {
      ...
      c._typingAnimation = window.requestAnimationFrame(c._typingAnimationFrame.bind(c,
        a));
  ...
  b._cursorAnimationFrame = function() {
    if (!this._settings.cursorAnimationPaused) {
      ...
      1 == this._settings.opacityIncreasing &&
        (1 <= this._settings.currentOpacity && (this._settings.opacityIncreasing = !1, this._settings.currentOpacity = 1), this._settings.currentOpacity += a);
  ...
  b._randomID = function() {
    for (var a = "", b = 0; b < this._randomInteger(5, 15); b++) a += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(62 * Math.random()));
    return a
  };
